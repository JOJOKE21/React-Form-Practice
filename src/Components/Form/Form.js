    ...
    return (
        <div className='froum'>
            <div className='forum-inputs'>
                ...
                <input name='name' type="text" className="input-field" placeholder="Name" defaultValue={''} onChange={onChangeName} maxLength={50}></input>
                ...
                <input name='address' type="text" className="input-field" placeholder="Home Address" defaultValue={''} onChange={onChangeName} maxLength={40}></input>
